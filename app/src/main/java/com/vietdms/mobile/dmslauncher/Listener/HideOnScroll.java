package com.vietdms.mobile.dmslauncher.Listener;
 ...
 */
public abstract class HideOnScroll extends RecyclerView.OnScrollListener {

    private int toolbarOffset = 0;
    private int toolbarHeight;

    public HideOnScroll(Context context) {
